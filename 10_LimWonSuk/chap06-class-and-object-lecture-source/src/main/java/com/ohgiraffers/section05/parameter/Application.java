...
public class Application
{
    public static void main(String[] args)
    {
        ...
        int[] arr = {1, 2, 3, 4, 5};
        pt.testPrimaryTypeArrayParameter(arr); // 배열 참조 주소가 복사되어 전달 = 얕은 복사
        ...
        /* 가변 인자 확인 */
        pt.testVariableLengthArrayParameter("홍길동", "도적질", "동번", "서번");
        pt.testVariableLengthArrayParameter("전진호", "스벅", "500만", "마카론", "염탐");
