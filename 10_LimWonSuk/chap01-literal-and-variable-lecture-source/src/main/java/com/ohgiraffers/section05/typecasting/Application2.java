...
public class Application2 {
    public static void main(String[] Args){
        ...
        * */
        ...
        long lnum1 = 100L;
        int inum1 = (int)lnum1;
        // lnum1을 (int)로 변환해서 해석하라고 컴파일러에게 알림

        short snum1 = (short)inum1;
        byte bnum1 = (byte)snum1;

        /* 실수 끼리 강제 형변환 + 데이터 손실*/
        double dnum2 = 0.1234567;
