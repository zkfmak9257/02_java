...
public class Application1 {
  public static void main(String[] args) {
    ...
    * JVM 내에 키보드 입력을 인식하는 입력 장치 생성*/
    ...
    /*2. 자료형 별 값 입력 받기*/
    /*2-1. 문자열(단어) 입력 받기*/
    String name = sc.nextLine(); // 다음 입력된 첫번째 토큰을 읽어와 문자열로 반환
    ...
    /*2-3 정수 입력 받기*/
    /*정수가 아닌 다른 자료형 또는 인트 범위 초과하는 정수 입력시 java.util.InputMismatchException이 발생한다.*/
    System.out.print("나이 입력 : ");
    int age = sc.nextInt(); //다음 입력된 첫번째 토큰을 읽어와 int로 변환하여 반환
    System.out.println("age = " + age);

    /*2-4 실수 입력 받기
    * 문자열 또는 더블 범위 초과시 java.util.InputMismatchException이 발생한다.*/
