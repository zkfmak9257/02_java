package com.work.section01.user_type;
...
public class Application {
  public static void main(String[] args) {
    ...
    *   (참조 자료형)
    *
    * new 클래스명() : new -> heap 영역에 클래스에 정의된 내용대로 메모리를 할당 == 객체(instance) 생성
    * */

    Member member = new Member(); //Member 객체 생성 후 주소 참조

    /* 참조 연산자(.)
     - 참조 변수가 참조하고 있는 객체의 필드 또는 메서드의 접근하는 연산자
    * */
...
//    -> JVM이 각 자료형 기본 값으로 초기화 함.
    // java - null : 참조하는 객체가 없다(주소 저장 X)
