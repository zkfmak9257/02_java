...
public class Application5 {
  ...
  public static void main(String[] args) {
    ...
    //com.my.section01.method.Application5 application5 = new com.my.section01.method.Application5();
    System.out.println(application5.plus(1, 3));
    
    /* static 메서드 호출*/
    System.out.println(application5.minus(1, 3));
