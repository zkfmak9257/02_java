...
public class Application2 {
  public static void main(String[] args){
    ...
    */
    ...
    // % (modulo, 나머지 연산)
    System.out.println(123 % 10); // 3 (정수)

    /*
      컴퓨터의 값 처리 원칙
      - 같은 타입(형식)끼리만 연산 가능
      - 같은 타입 연산 결과는 꼭 같은 타입이 된다.
    */
    ...
    /* java에서 실수(float, double)는
      실제 딱 떨어지는 값이 아니고 근사치다
    */
    ...
    System.out.println('a' + 1.0); // 97(정수) == '' 문자는 정수로 저장됨을 확인
