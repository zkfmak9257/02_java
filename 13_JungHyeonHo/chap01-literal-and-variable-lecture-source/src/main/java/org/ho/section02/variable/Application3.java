...
public class Application3 {
  public static void main(String[] args) {
    ...
    /* a. 지급 포인트를 200으로 변경, 변수 미사용*/
    System.out.println("1번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("2번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("3번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("4번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("5번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("6번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("7번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("8번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("9번 고객에게 포인트를 200포인트 지급했습니다.");
    System.out.println("10번 고객에게 포인트를 200포인트 지급했습니다.");

    /* b. 지급 포인트를 200으로 변경 (변수 사용) */
    int point = 200;
