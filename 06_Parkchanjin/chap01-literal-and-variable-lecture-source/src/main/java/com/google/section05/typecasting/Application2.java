package com.google.section05.typecasting;
...
public class Application2 {
  public static void main(String[] args) {
    ...
    *
    *
    * - 강제 형변환 시 값의 범위가 다를 경우 "데이터 손실이"이 발생할 수 있다*/

    /* 정수 끼리 강제 형변환 */
    long lnum1 = 100L;
    int inum1 = (int) lnum1; // lnum1 을 (int)로 변환해서 해석하라고 컴파일러에게 알림

    short snum1 = (short) inum1;
    byte bnum1 = (byte) snum1;

    /* 실수 끼리 강제 형변환 + 데이터 손실 */
    double dnum2 = 0.12345678790123456789;
