...
public class Application2 {
  public static void main(String[] args) {
    ...
    /* java & 개발자들의 약속(규약) */
    // 2-1. 변수명의 길이 제한은 없다
    int wkfnasdnflsdnfgjksdnvklxcnvkxcnjkvfnsdjlfnsdklnvdvlvk = 10;
    System.out.println("wkfnasdnflsdnfgjksdnvklxcnvkxcnjkvfnsdjlfnsdklnvdvlvk = " + wkfnasdnflsdnfgjksdnvklxcnvkxcnjkvfnsdjlfnsdklnvdvlvk);
    ...
    String myNameIsParkChanJin = "박찬진";
    ...
    // - 한글, 한자 등은 호환 문제가 발생할 수 있기 때문에...ㅜ
    int 나이 = 20;
    String 이름 = "홍길동";
    double 몸무게 = 70.1;
