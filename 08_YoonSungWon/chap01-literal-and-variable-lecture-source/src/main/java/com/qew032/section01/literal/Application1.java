...
public class Application1 {
  ...
  public  static void main(String[] args){
    ...
    // 2. 문자 형태의 값 출력
    System.out.println('a'); // a라는 문자 1개, ' ' 홑 따옴표로 감싸야 함

    // sout : System.out.println(); 의 snippet (단편,약어)
    System.out.println('1');    // '1' == 문자 1, 1 == 정수 1
                                               // '1' == 1 -> false

    //System.out.println('ab');   // ' ' 내에는 한 글자만 가능하다.
    //System.out.println('');       // ' ' 내에는 한 글자가 무조건 필요!

    // 3. 문자열 형태
    System.out.println("안녕하세요");    // 문자열은 "" (쌍또옴표)로 감싸져 있어야 한다.
    System.out.println("123");    // 숫자 x 문자 x 문자열 o
    System.out.println("1");    // 한 글자만 들어가도 문자열("")
                                                // 'a' == "a"  -> false
