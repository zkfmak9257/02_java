...
public class Application2 {
  ...
  public static void main(String[] args) {
    ...
    */
    ...
    System.out.println(123 / 10); // 12 (정수)
    System.out.println(123 % 10); // %(modulo, mod) : 나머지 연산
    // 12...3
    ...
    */
    ...
    System.out.println(1.23 * 0.5);
    System.out.println(1.23 / 0.5);
    System.out.println(1.23 % 1.0); // 예상 : 0.23, 실제 : 0.22999999999999998
    ...
    * */
    ...
    // System.out.println("Hello" - "World"); // 애러
    // System.out.println("Hello" * "World"); // 애러
    // System.out.println("Hello" / "World"); // 애러
    // System.out.println("Hello" % "World"); // 애러
    ...
    * - 대신 비교 연산(==, !=), 논리 연산을 사용
    *  */
    System.out.println("====== 논리 값의 연산 ======");
    // System.out.println(true + true);  // 애러
    System.out.println(true == true); // 결과 : true
    System.out.println(true != true); // 결과 : false
