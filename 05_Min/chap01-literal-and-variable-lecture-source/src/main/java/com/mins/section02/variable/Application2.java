...
public class Application2 {
  ...
  public static void main(String[] args) {
    ...
    /* 개발자들의 약속(규약) */
    // 2-1. 변수명의 길이 제한은 없다
    int gaehesiogheriogjaeroiae = 10;
    System.out.println("gaehesiogheriogjaeroiae = " + gaehesiogheriogjaeroiae);

    // 2-2. 여러 단어의 합성어는 Camel_case 형식으로 작성한다.
    // Camel-case(낙타 표기법)
    // - 모든 단어를 붙여 쓰되, 연결되는 단어의 첫 글자를 대문자로 표현
    int maxAge = 40;
    int showMeTheMoney = 10000;
    String myNameIsJiMin = "지민";

    // 2-3. 단어와 단어 사이를 연결할 때 _(언더스코어)를 사용하지 않는다
    // Snake_Case : 연결되는 단어 사이를 _로 연결
    ...
    // 2-5. 변수명은 저장된 값이 어떤 의미를 가지는 지 알 수 있게 작명한다
