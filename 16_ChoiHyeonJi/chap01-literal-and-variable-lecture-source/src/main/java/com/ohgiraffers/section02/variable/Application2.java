...
public class Application2 {
  public static void main(String[] args) {
    ...
    /* java & 개발자들의 약속 (규약) */
    // 2-1. 변수명의 길이 제한은 없다
    int qeurhwieulfheialuwfhywiehfywuifhweufhawufkhae = 10;
    System.out.println("qeurhwieulfheialuwfhywiehfywuifhweufhawufkhae = " + qeurhwieulfheialuwfhywiehfywuifhweufhawufkhae); //soutv : 가장 가까운 변수 출력
    ...
    String myNameIsChoiHyeonJi = "최현지";

    System.out.println("showMeTheMoney = " + showMeTheMoney);

    // 2-3. 단어와 단어 사이를 연결할 때 _(언더 스코어)를 사용하지 않는다
