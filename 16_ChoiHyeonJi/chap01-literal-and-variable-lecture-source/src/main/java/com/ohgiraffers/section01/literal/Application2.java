...
public class Application2 {
   ...
   */
    ...
    */
    ...
    System.out.println(123 / 10); // 12  12.3 12....3?  => 12(정수)

    /*
      컴퓨터의 값 처리 원칙
      - 같은 타입 (형식) 끼리만 연산 가능 ex. 논리형은 논리형끼리만 가능
      - 같은 타입 연산의 결과는 꼭 같은 타입이 된다.
    */
    System.out.println(123 % 10); // %(modulo, mod) - 나머지 3 (정수)
    ...
    */
    ...
    System.out.println(1.23 * 0.5);
    System.out.println(1.23 / 0.5);
    System.out.println(1.23 % 1.0); // 예상 : 0.23, 실제 : 0.22999999998
    ...
    System.out.println(123 * 0.5);
    System.out.println(123 / 0.5); // 나누기
    System.out.println(123 % 0.5); // 나머지 0.0(실수)
    ...
    */
    ...
    /*
     *  7. 문자열과 문자열 연산
     * - 문자열 a + 문자열 b =  문자열A문자열B (이어쓰기, + 연산)
     * - 나머지 산술 연산자(-, *, /, %) 연산 자체가 안됨!! (오류)
     */

    System.out.println("hello" + "world");
//    System.out.println("hello" - "world"); //에러
//    System.out.println("hello" * "world"); //에러      주석 ctrl + /
//    System.out.println("hello" / "world"); //에러
//    System.out.println("hello" % "world"); //에러
