package com.kth.section02.variable;
...
public class Application2 {
  public static void main(String[] args){
    ...
    /* 개발자들의 약속(규약) */
    // 2-1. 변수명의 길이 제한은 없다
    int qrewttyrurfadsasddgfhgjfdsa = 10;
    System.out.println("qrewttyrurfadsasddgfhgjfdsa = " + qrewttyrurfadsasddgfhgjfdsa);
