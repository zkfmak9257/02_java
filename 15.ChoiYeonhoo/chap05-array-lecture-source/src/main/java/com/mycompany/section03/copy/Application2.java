...
public class Application2 {
  public static void main(String[] args) {
    ...
    /* 깊은 복사 : 기존 객체(배열)와 똑같은 객체를 만드는 것 */
    ...
    int[] copy2 = origin.clone(); /* 짧지만 이해 없이 사용은 권장하지 않는다. */

    /* 3. System.arraycopy() 메서드를 이용한 깊은 복사 */
    int[] copy3 = new int[origin.length];
    System.arraycopy(origin, 0, copy3, 0, origin.length); // origin의 0번부터 복사, 복사할 arr, 0부터 넣음, origin의 길이)
