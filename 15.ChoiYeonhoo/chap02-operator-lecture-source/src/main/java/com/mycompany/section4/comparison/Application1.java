package com.mycompany.section4.comparison;

public class Application1 {
  public static void main(String[] args) {
    /* 비교 연산자
    * - == , !=, >=, <=, >, <
    * - 비교연산자의 수행 결과는 항상 true/false (boolean)
    ...
    * */
    ...
    System.out.println("inum1이 inum2보다 작은지 비교 : " + (inum1 < inum2)); // ture
    System.out.println("inum1이 inum2보다 작은거나 같은지 비교 : " + (inum1 <= inum2)); // true
    ...
    /* str1 == str2 -> true인 이유
    * - "java" == "java" : 저장된 문자열을 모두 비교 X
    * - str1, str2 변수에 저장된 주소를 비교함
    * */

    /* 실제 String 값 비교 하는 방법 -> A.equals(B) 이용 */
    System.out.println("str1, str2 실제 값 비교 = " + str1.equals(str2));

    String str3 = "구내식당";
    String str4 = new String("구내식당");

    System.out.println("str3 = " + str3); // 구내식당
    System.out.println("str4 = " + str4); // 구내식당
    System.out.println("str3 == str4 : " + (str3 == str4)); // 주소비교, false
    System.out.println(str3.equals(str4)); // 실제값 비교, true
