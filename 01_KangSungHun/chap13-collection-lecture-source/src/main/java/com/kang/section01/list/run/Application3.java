...
import com.kang.section01.list.service.BookService;
...
public class Application3 {
  ...
  private void updateBook( ) {
    ...
    System.out.println("*** 책 정보가 수정 되었씁니다. *** ");
  ...
  private void searchBook(){
    ...
    if(searchBookList == null || searchBookList.isEmpty()){ // 널이고 비어있다면
